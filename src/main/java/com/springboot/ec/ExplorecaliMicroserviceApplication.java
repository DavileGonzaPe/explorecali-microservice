...
import com.springboot.ec.domain.Difficulty;
import com.springboot.ec.domain.Region;
import com.springboot.ec.service.TourPackageService;
import com.springboot.ec.service.TourService;

import static com.fasterxml.jackson.annotation.JsonAutoDetect.Visibility.ANY;
import static com.fasterxml.jackson.annotation.PropertyAccessor.FIELD;

@SpringBootApplication
public class ExplorecaliMicroserviceApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(ExplorecaliMicroserviceApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {	
		...
		createTours("ExporeCalifornia.json");
